...
class WordSpout(Spout):
    outputs = ["word"]
    def consumer(self, hosts=None, topic=None, auto_commit_enable=True, auto_offset_reset=OffsetType.EARLIEST):
    ...
    def initialize(self, stormconf, context):
        self.messages = self.consumer(hosts="10.129.7.121:9092", topic='auditlog')
